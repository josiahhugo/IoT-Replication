...
print(f"Loaded {labels.count(0)} benign samples.\n")
...
print(f"Loaded {labels.count(1)} malware samples.\n")

# DEBUG: Show total samples
print(f"Total samples: {len(samples)} Benign: {labels.count(0)}, Malware: {labels.count(1)}")
...
print("CIG computed for all features.\n")

# combine both scores
print("Selecting top 82 features based on CIG scores...")
...
# DEBUG: Output Sumamry
print(f"Selected top 82 features.")
print(f"Final selected feature matrix shape: {X_selected.shape}")
print(f"Sample of selected feature names: {selected_feature_names[:5]}")